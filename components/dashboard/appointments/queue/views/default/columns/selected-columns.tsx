...
export default function SelectedColumns({
  ...
  return (
    <ScrollShadow className="border-l border-divider px-4">
      <DragDropProvider
...
function Sortable({
  ...
  return (
    <li
      ...
      ref={ref}
      className="flex h-8 items-center justify-between rounded-small px-2 transition-colors hover:bg-default-100"
    >
      <div className="flex items-center gap-2">
        <span ref={handleRef} className="rounded-full hover:cursor-grab hover:bg-default-200">
