...
export default function TabularView({ session }: { session: any }) {
  ...
  const sortedItems = React.useMemo(() => {
    return [...items].sort((a: AppointmentType, b: AppointmentType) => {
    ...
    (appointment: AppointmentType, columnKey: React.Key) => {
      ...
      switch (columnKey) {
        ...
        case 'createdAt':
          return (
            <div className="space-y-1">
              <FormatTimeInTable date={appointment.createdAt} template="PP" />
              <FormatTimeInTable
  ...
  return (
    <>
      ...
      >
        ...
        <TableBody items={sortedItems} emptyContent={'No appointments found'}>
          {(item) => (
            <TableRow
              key={item.aid}
            ...
            <>
              <ModalHeader className="flex-col items-center">
                ...
                <h2 className="mt-4 max-w-xs text-center text-base">
                  ...
                  {selected?.patient.name} from the Database?
                </h2>
              </ModalHeader>
              ...
              <ModalFooter className="flex-col-reverse sm:flex-row">
                ...
                <Button
                  ...
                  variant="flat"
                  fullWidth
                  // onPress={() => handleDelete(selected as AppointmentType)}
                >
                  Delete
                </Button>
              </ModalFooter>
