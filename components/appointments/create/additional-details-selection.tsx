...
export default function AdditionalDetailsSelection({
  ...
  handleAppointmentChange: (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => void;
  onContinue: () => void;
...
export function AdditionalDetailsSelectionTitle() {
  return (
    <div className="space-y-4">
      <h3 className="text-2xl font-semibold">Addional Information (Optional)</h3>
    </div>
  );
}
