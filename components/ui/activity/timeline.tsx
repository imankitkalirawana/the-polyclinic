  ...
  return (
    <ScrollShadow className="flex max-h-[32vh] flex-col gap-2 overflow-auto px-2 py-4 pb-12">
      <ul className="relative">
        <div className="absolute bottom-0 left-4 top-5 w-px bg-gradient-to-b from-divider via-divider to-transparent"></div>
            ...
            {activity.metadata?.fields &&
              ...
              visibleFields < activity.metadata?.fields?.length && (
                ...
                >
                  ...
                  <span>
                    Show {activity.metadata?.fields?.length - visibleFields}{' '}
                    similar activities
                  </span>
                </button>
              )}
