...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-10 items-center justify-center rounded-medium bg-default-100 p-1 text-default-500',
      className
    )}
    {...props}
  />
