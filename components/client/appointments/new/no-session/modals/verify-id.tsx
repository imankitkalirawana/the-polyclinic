        ...
        <>
          <ModalHeader className="flex-col items-center">
            ...
            <h2 className="text-2xl font-semibold">
              Verify {formik.values.id?.includes('@') ? 'Email Address' : 'Phone Number'}
            </h2>
          </ModalHeader>
          <ModalBody className="items-center">
            <p className="text-center">
              ...
              <strong>
                {formik.values.id.includes('@') ? formik.values.id : `+91 ${formik.values.id}`}
              </strong>
            </p>
            <InputOtp
              length={4}
            ...
            <div className="flex items-center gap-2 text-small">
              ...
              <Link href="#" isDisabled className="text-small hover:underline">
                Resend
              </Link>
            </div>
          </ModalBody>
