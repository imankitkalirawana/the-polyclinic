        ...
        return (
          <Popover key={item.slug} open={isActive && !isMobile}>
            ...
            >
              <Card
                className={cn(
                  'bg-grid-slate-900/70 relative h-full w-full overflow-hidden [mask-image:linear-gradient(0deg,#fff,rgba(255,255,255,0.6))]'
                )}
              >
                <div
                  aria-hidden="true"
      ...
      <Modal
        ...
        classNames={{
          base: [
            'mt-[20vh]',
            'border-small',
            'dark:border-default-100 border-default-100',
