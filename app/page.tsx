    ...
    <>
      <section className="section bg-accentPrimary">
        <div className="m-auto max-w-screen-2xl overflow-hidden px-6 md:px-10 lg:px-14">
          <h1 className="top-32 z-[1] m-0 w-auto p-0 pt-12 text-center text-[50px] font-bold md:relative md:top-[72px] md:p-0 md:text-4xl lg:top-32 lg:text-[118px] lg:leading-[118px]">
            Mortgages
            <br />
            made simple
          </h1>
          <div className="relative flex flex-col items-center justify-center md:flex-row">
            <div className="w-80 md:w-auto">
              <a
                className="bg-graphTertiary hover:bg-accentPrimary hover:text-interactiveForegroundPrimary mt-lg md:mt-none inline-flex h-16 w-full items-center justify-center whitespace-nowrap rounded-full px-12 py-5 text-base font-bold leading-normal transition-all duration-200 ease-in-out disabled:pointer-events-none disabled:opacity-50 md:w-fit"
                href="/start"
              >
                Start my approval
              </a>
              <div className="text-accentSecondary mt-3 flex items-center justify-center gap-1 text-sm">
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 16 17"
        ...
        4.6<!-- --> Stars | <!-- -->3177<!-- --> <!-- -->Google reviews</div> */}
            </div>
          </div>
        </div>
      </section>
